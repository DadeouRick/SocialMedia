...
public class AddPostVideoActivity extends AppCompatActivity {
    ...
    private static final int VIDEO_PICK_GALLERY_CODE = 301;
    private static final int VIDEO_PICK_CAMERA_CODE = 401;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoVv = findViewById(R.id.pvideo);
    ...
    private void setListeners() {
        upload.setOnClickListener(view -> {
            ...
            if (video_uri == null){
                //post without image
                //uploadData(title, description, "noVideo");
                showToast("Select a Video");
            } else {
                //post with image
                uploadData(title, description, String.valueOf(video_uri));
            }
        });
        //get image from camera or gallery on imageview click
        videoVv.setOnClickListener(view -> {
            showImagePickDialog();
        });
    }
    ...
    private void uploadData(String title, String description, String uri) {
        ...
        if (!uri.equals("noImage")){
            ...
            hashMap.put("pTime", timeStamp);
            //path to store post data
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference("PostsVideo");
            //put data in this ref
    ...
    private void pickFromCamera() {
        ...
        values.put(MediaStore.Video.Media.TITLE, "Temp Pick");
        ...
        startActivityForResult(cameraIntent, VIDEO_PICK_CAMERA_CODE);
    }

    private void pickFromGallery() {
        Intent galleryIntent = new Intent(Intent.ACTION_PICK);
        galleryIntent.setType("video/*");
        startActivityForResult(galleryIntent, VIDEO_PICK_GALLERY_CODE);
    }
